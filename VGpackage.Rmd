...
2. Use devtools::install() to downlaod package 
3. load package using library(VideoGameAnalytics)
4. make sure to load all libraries by using devtools::load_all()  (else certain functions won't run due to not finding functions)
